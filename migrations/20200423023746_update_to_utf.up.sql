...
ALTER TABLE `TeacherRecords` MODIFY COLUMN `content_description` VARCHAR(500) CHARACTER SET `utf8` COLLATE `utf8_unicode_ci` NOT NULL;
...
ALTER TABLE `StudentRecords` MODIFY COLUMN `content_description` VARCHAR(500) CHARACTER SET `utf8` COLLATE `utf8_unicode_ci` NOT NULL;
